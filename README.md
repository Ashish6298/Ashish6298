...
<h4 align="center">
I'm Ashish Goswami, a passionate Information Science & Engineering undergraduate from India, diving deep into the world of tech with a love for building impactful solutions. Whether it's crafting user-friendly mobile apps, developing AI-powered platforms, or exploring open-source contributions, I am always eager to innovate and grow.</h4>

---

## 🚀 What I Do:

💡 App Developer: Proficient in Flutter, Firebase, Android Studio, and Dart with hands-on experience in AI-powered healthcare solutions and interactive applications.

🌐 Web Developer: Developed responsive and dynamic web apps using React.js, Node.js, and MongoDB.

🧠 AI Enthusiast: Built AI-driven projects like Medisynth for virtual medical training and CareLink for hospital management.

🔎 Problem Solver: Always excited to tackle complex problems using clean and efficient code.
...
<div>
  ...
  <img src="https://www.vectorlogo.zone/logos/adobe_xd/adobe_xd-icon.svg" title="Adobe XD" alt="Adobe XD" width="40" height="40"/>&nbsp;
